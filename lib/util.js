...
const util = {
  ...
  updateBranding: () => {
    ...
    let fileMap = new Set();
    fileMap.add([path.join(braveAppDir, 'brave_strings.grd'), path.join(chromeAppDir, 'brave_strings.grd')])
    fileMap.add([path.join(braveAppDir, 'settings_brave_strings.grdp'), path.join(chromeAppDir, 'settings_brave_strings.grdp')])
    fileMap.add([path.join(braveAppDir, 'components_brave_strings.grd'), path.join(config.srcDir, 'components', 'components_brave_strings.grd')])
